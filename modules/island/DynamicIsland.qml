...
Item {
    ...
    states: [
        ...
        State {
            name: "collapsed"
            when: !root.expanded
            PropertyChanges { target: root; width: FrameConfig.dynamicIslandCollapsedWidth; height: root.barHeight; blurAmount: 0.5; cornerHeight: 0; focus: false }
    ...
    transitions: [
        Transition {
            to: "expanded"
            ParallelAnimation {
                NumberAnimation { properties: "width,height,blurAmount,cornerHeight"; duration: FrameConfig.animDuration; easing.type: FrameConfig.animEasing }
                NumberAnimation { target: islandBodyMover; property: "y"; duration: FrameConfig.animDuration; easing.type: FrameConfig.animEasing }
                SequentialAnimation {
                    PauseAnimation { duration: FrameConfig.animDuration * 0.7 }
                    NumberAnimation { target: islandContentArea; property: "opacity"; to: 1; duration: 150 }
                }
            }
        },
        Transition {
            to: "collapsed"
            SequentialAnimation {
                NumberAnimation { target: islandContentArea; property: "opacity"; to: 0; duration: 100 }
                ParallelAnimation {
                    NumberAnimation { properties: "width,height,blurAmount"; duration: FrameConfig.animDuration; easing.type: FrameConfig.animEasing }
                    NumberAnimation { target: root; property: "cornerHeight"; to: 0; duration: FrameConfig.animDuration * 0.8; easing.type: FrameConfig.animEasing }
                    NumberAnimation { target: islandBodyMover; property: "y"; duration: FrameConfig.animDuration; easing.type: FrameConfig.animEasing }
                }
            }
        }
    ...
    Item {
        id: islandContainer
        anchors.fill: parent
        readonly property bool isStatic: Math.abs(root.width - (root.expanded ? FrameConfig.dynamicIslandExpandedWidth : FrameConfig.dynamicIslandCollapsedWidth)) < 1.0
        ...
        Item {
            ...
            Rectangle {
                ...
                visible: opacity > 0; z: -1; layer.enabled: true
                layer.effect: MultiEffect { blurEnabled: true; blur: 0.6 }
                Behavior on opacity { NumberAnimation { duration: 200 } }
            }

            RoundedCornerShape {
                anchors.right: islandRect.left; anchors.rightMargin: -1; anchors.top: islandRect.top; anchors.topMargin: 16
                width: FrameConfig.roundedCornerShapeWidth + 1; height: root.cornerHeight
                isLeft: true; isTop: true; cornerRadius: FrameConfig.roundedCornerShapeRadius
                cornerColor: root.barColor; opacity: root.cornerHeight > 1 ? 1.0 : 0.0
            }

            RoundedCornerShape {
                anchors.left: islandRect.right; anchors.leftMargin: -1; anchors.top: islandRect.top; anchors.topMargin: 16
                width: FrameConfig.roundedCornerShapeWidth + 1; height: root.cornerHeight
                isTop: true; cornerRadius: FrameConfig.roundedCornerShapeRadius
                cornerColor: root.barColor; opacity: root.cornerHeight > 1 ? 1.0 : 0.0
            }

            ClippingRectangle {
                id: islandRect; anchors.fill: parent; color: root.barColor
                topLeftRadius: 0; topRightRadius: 0; bottomLeftRadius: root.radius; bottomRightRadius: root.radius
                HoverHandler { id: hoverHandler }

                Item {
                    id: islandContentArea; anchors.fill: parent; opacity: 0; clip: true
                    layer.enabled: root.blurAmount > 0.01
                    layer.effect: MultiEffect { blurEnabled: true; blur: root.blurAmount }
                    ...
                    PathView {
                        ...
                        visible: opacity > 0; model: tabModel
    ...
    ListModel {
        ...
        Component.onCompleted: {
            ...
            try {
                if (UPower.displayDevice && UPower.displayDevice.type !== 0) {
                    append({ "type": "battery" }) 
                }
            } catch (e) {}
