...
PanelWindow {
    ...
    IslandSurface {
        ...
        topLeftRadius: root.customTopLeftRadius !== undefined ? root.customTopLeftRadius : ((root.isAtTop && !root.isInCorner) ? 0 : root.cornerRadius)
        topRightRadius: root.customTopRightRadius !== undefined ? root.customTopRightRadius : ((root.isAtTop && !root.isInCorner) ? 0 : root.cornerRadius)
        bottomLeftRadius: root.customBottomLeftRadius !== undefined ? root.customBottomLeftRadius : ((root.isAtBottom && !root.isInCorner) ? 0 : root.cornerRadius)
        bottomRightRadius: root.customBottomRightRadius !== undefined ? root.customBottomRightRadius : ((root.isAtBottom && !root.isInCorner) ? 0 : root.cornerRadius)
